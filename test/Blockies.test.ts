...
describe('Blockies', function () {
	...
	it('return correct svg', async function () {
		...
		expect(await Blockies.callStatic.tokenURI(users[0].address)).to.be.equal(
			`data:application/json,{\"name\":\"0x3c44cdddb6a900fa2b585dd299e03d12fa4293bc\",\"description\":\"Blocky%200x3c44cdddb6a900fa2b585dd299e03d12fa4293bc%20Generated%20On-Chain\",\"image\":\"data:image/svg+xml,<svg%20xmlns='http://www.w3.org/2000/svg'%20shape-rendering='crispEdges'%20width='512'%20height='512'><g%20transform='scale(64)'><path%20fill='hsl(245,047%,055%)'%20d='M0,0h8v8h-8z'/><path%20fill='hsl(048,045%,063%)'%20d='M0,0h1v0h-1zm1,0h1v0h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v0h-1zm1,0h1v0h-1zm-8,1m1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v0h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v0h-1zm1,0h1v1h-1zm1,0h1v1h-1zm-8,1m1,0h1v1h-1zm1,0h1v0h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v0h-1zm1,0h1v1h-1zm-8,1m1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v1h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v1h-1zm1,0h1v0h-1zm1,0h1v0h-1zm-8,1m1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v1h-1zm-8,1m1,0h1v0h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v0h-1zm-8,1m1,0h1v0h-1zm1,0h1v1h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v1h-1zm1,0h1v0h-1zm-8,1m1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v1h-1z'/><path%20fill='hsl(266,078%,048%)'%20d='M0,0h1v1h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v1h-1zm-8,1m1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm-8,1m1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm-8,1m1,0h1v1h-1zm1,0h1v1h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v1h-1zm1,0h1v1h-1zm-8,1m1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm-8,1m1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm-8,1m1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm-8,1m1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1zm1,0h1v0h-1z'/></g></svg>\"}`
		);
	});
	...
	it('non owner cannot set ENS name', async function () {
		const state = await setup();
		const {users} = state;
		await expect(users[0].Blockies.setENSName('hello.eth')).to.be.reverted;
	});
	...
	it('non owner cannot change owner', async function () {
		const state = await setup();
		const {users} = state;
		await expect(users[0].Blockies.transferOwnership(users[1].address)).to.be.reverted;
	});
	...
	it('owner cannot change owner after having already changed it', async function () {
		...
		await expect(initialOwnerOfBlockyZero.Blockies.transferOwnership(users[1].address)).to.be.reverted;
	});
});
